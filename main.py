...
all_lines_simple =  ["💓AKTV🚀📶,#genre#"] + sorted(set(correct_name_data(corrections_name,mtv_lines))) +read_txt_to_array('专区/about.txt')+ ['\n'] +\
...
#             ["💓AKTV🚀📶,#genre#"] + aktv_lines + ['\n'] + \             
all_lines =  ["💓AKTV🚀📶,#genre#"] + sorted(set(correct_name_data(corrections_name,mtv_lines))) +read_txt_to_array('专区/about.txt') + ['\n'] +\
             ["💓专享源🅰️,#genre#"] + read_txt_to_array('专区/♪专享源①.txt') + ['\n'] + \
             ["💓专享源🅱️,#genre#"] + read_txt_to_array('专区/♪专享源②.txt') + ['\n'] + \
             ["💓专享央视,#genre#"] + read_txt_to_array('专区/♪优质央视.txt') + ['\n'] + \
             ["💓专享卫视,#genre#"] + read_txt_to_array('专区/♪优质卫视.txt') + ['\n'] + \
